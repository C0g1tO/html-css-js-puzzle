...
var imgOrder = ["berzerk_4", "berzerk_2", "berzerk_8", "berzerk_9", "berzerk_1", "berzerk_6", "berzerk_7", "berzerk_5", "berzerk_3"];
// var imgOrder = ["berzerk_8", "berzerk_1", "berzerk_2", "berzerk_9", "berzerk_4", "berzerk_3", "berzerk_7", "berzerk_6", "berzerk_5"];

window.onload = function() {
    for (let r=0; r < rows; r++) {
        for (let c=0; c < columns; c++) {

            //<img id="0-0" src="berzerk_1.jpg">
...
function dragStart() {
    currTile = this; //this refers to the img tile bing dragged
}
